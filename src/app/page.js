...
import HealthCard from "../components/briefing/BusinessHealth";
import MissionCard from "../components/briefing/MissionCard";
import ImpactCard from "../components/briefing/BusinessImpact";
    ...
    <AppLayout>
      <section className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mt-10">
          <HealthCard
            score={company.businessHealth}
            status={company.healthStatus}
            confidence={company.confidence}
          />

          <MissionCard
            location={dailyBrief.mission.location}
            action={dailyBrief.mission.objective}
          />

          <ImpactCard
            amount={dailyBrief.mission.estimatedImpact}
            period="Estimated Weekly Impact"
          />
        </div>
        <DailyBrief
