        ...
        <section className="max-w-7xl mx-auto">
          ...
          <div className="mt-10 bg-slate-900 p-6 rounded-2xl border border-slate-800">
            ...
            <p className="text-slate-300 mt-3">
              ...
              weakest health score and lowest profit. Labor and food cost are
              both above target, creating a prime cost of 71.9%. Recommend
              reviewing staffing levels, protein usage, and purchasing controls
              this week.
            </p>
          </div>
        </section>
