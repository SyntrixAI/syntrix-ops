    ...
    <Card className="transition hover:border-cyan-500/30">
      <div className="flex items-start justify-between">
        <div>
          ...
          <p className="mt-2 text-slate-400">{execution.location}</p>
        </div>

        <div className="mt-4">
          <p className="text-sm text-slate-500">Source Assessment</p>
        ...
        <Badge tone="warning">{execution.status}</Badge>
      </div>
      ...
      <div className="mt-8 grid gap-6 md:grid-cols-2">
        ...
        <div>
          <p className="text-sm text-slate-400">Why Now?</p>

          <p className="mt-2 text-white">{execution.whyNow}</p>
        </div>
      </div>
      ...
      <div className="mt-8 flex flex-wrap gap-6">
        <div>
          ...
          <p className="font-semibold text-white">{execution.effort}</p>
        </div>

        <div>
          <p className="text-sm text-slate-400">Estimated Time</p>
          <p className="font-semibold text-white">{execution.estimatedTime}</p>
        </div>
