    ...
    <section className="mt-10">
      <div>
        ...
        <p className="mt-2 max-w-3xl text-slate-400">
          Recommended actions generated from Syntrix priorities.
        </p>
      </div>
          ...
          <Card key={item.id}>
            ...
            <div className="mt-6 grid gap-4 lg:grid-cols-3">
                ...
                <div className="rounded-xl border border-slate-800 bg-slate-950/60 p-4">
                  ...
                  <ul className="mt-3 space-y-2">
                    {item.dependencies.map((dependency) => (
                      <li key={dependency} className="text-sm text-slate-400">
                        • {dependency}
                      </li>
                    ))}
                  </ul>
                ...
                <div className="rounded-xl border border-slate-800 bg-slate-950/60 p-4">
                  ...
                  <ul className="mt-3 space-y-2">
                    {item.successCriteria.map((criteria) => (
                      <li key={criteria} className="text-sm text-slate-400">
                        ✓ {criteria}
                      </li>
                    ))}
                  </ul>
              ...
              {(item.risk || item.followUp) && (
                <div className="rounded-xl border border-slate-800 bg-slate-950/60 p-4">
                  <h4 className="font-semibold text-white">Risk & Follow-up</h4>
