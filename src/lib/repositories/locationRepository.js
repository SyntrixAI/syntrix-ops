...
function requireOrganizationId(organizationId) {
  if (!organizationId) {
    throw new Error("Location repository requires an organization ID.");
  }
}
...
export function getLocationById({ organizationId, locationId } = {}) {
  if (!locationId) {
    throw new Error("Location repository requires a location ID.");
  }
...
export function getLocationsByDistrict({
  ...
  if (!districtId) {
    throw new Error("Location repository requires a district ID.");
  }
